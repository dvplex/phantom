...
Route::group(['middleware' => ['auth']], function () {
	...
	Route::get('/{lang?}/cms/modify/{id}/', 'CMSController@edit')->name('phantom.modules.cms@edit');
	Route::post('/{lang?}/cms/add/', 'CMSController@store')->name('phantom.modules.cms@store');
	Route::post('/{lang?}/cms/edit/', 'CMSController@update')->name('phantom.modules.cms@update');
	Route::post('/{lang?}/cms/delete/', 'CMSController@destroy')->name('phantom.modules.cms@destroy');
