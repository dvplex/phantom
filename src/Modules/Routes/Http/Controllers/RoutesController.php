...
class RoutesController extends Controller {
    ...
    public function search(Request $request) {
        $routes = Route::with('http_methods', 'middlewares', 'roles', 'permissions')
    ...
    public function store(Request $request) {
        ...
        $validatedData = $request->validate([
            'route'            => "required|unique:routes,route,NULL,id,deleted_at,NULL|max:255|without_spaces",
        ...
        $module = Module::with('routes.middlewares', 'routes.roles', 'routes.permissions')->findOrFail($request->moduleId);
    ...
    public function update(Request $request) {
        ...
        $module = Module::with('routes.middlewares', 'routes.roles', 'routes.permissions')->findOrFail($request->module_id);
        $routes = $module->routes()->paginate(5);
    ...
    public function destroy(Request $request) {
        Middleware::where('route_id', $request->id)->delete();
        HttpMethod::where('route_id', $request->id)->delete();
