...
Route::group(['middleware' => ['auth']], function ($router) {
    ...
    Route::get('/{lang?}/admin/settings/modules/{module:module_name}', 'ModulesController@show')->name('phantom.modules.modules@show');
    ...
    Route::post('/{lang}/admin/modules/delete', 'ModulesController@destroy')->name('phantom.modules.modules@delete');
