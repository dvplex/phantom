...
class ModulesServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            module_path('Modules', 'Config/config.php') => config_path('modules.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('Modules', 'Config/config.php'), 'modules'
        );
    }
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(module_path('Modules', 'Resources/lang'), 'modules');
        }
    }
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('Modules', 'Database/factories'));
        }
    }
